...
silent only
silent tabonly
cd ~/source/translations/kivan_russian_translation
...
argglobal
%argdel
$argadd tra/russian/P\#KINEW.tra
$argadd tra/english/p\#kinew.tra
$argadd d/p\#kinew.d
edit tra/russian/P\#KINEW.tra
...
silent! normal! zE
let s:l = 1074 - ((17 * winheight(0) + 9) / 18)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1075 - ((17 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 1075
...
wincmd w
argglobal
if bufexists("d/p\#kinew.d") | buffer d/p\#kinew.d | else | edit d/p\#kinew.d | endif
balt tra/russian/P\#KINEW.tra
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2873 - ((16 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 2873
...
exe '3resize ' . ((&lines * 18 + 29) / 58)
tabnext 1
badd +1 tra/russian/P\#KINEW.tra
badd +1 tra/english/p\#kinew.tra
badd +1 d/p\#kinew.d
