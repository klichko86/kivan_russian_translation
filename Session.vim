...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-racer,~/.vim/plugged/rust.vim,~/.vim/plugged/vim-bracketed-paste,~/.vim/plugged/vim-sensible,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after
set spelllang=ru_ru
...
exe '2resize ' . ((&lines * 12 + 23) / 46)
exe '3resize ' . ((&lines * 15 + 23) / 46)
argglobal
...
silent! normal! zE
let s:l = 340 - ((5 * winheight(0) + 7) / 15)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 322 - ((0 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 322
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1459 - ((14 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 1459
